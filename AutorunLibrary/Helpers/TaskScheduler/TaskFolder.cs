...
using AutorunLibrary.Helpers.TaskScheduler.V1Interop;
using AutorunLibrary.Helpers.TaskScheduler.V2Interop;
...
#pragma warning restore 0618
		...
		public TaskFolder CreateFolder( string subFolderName, GenericSecurityDescriptor sd) => CreateFolder(subFolderName, sd == null ? null : sd.GetSddlForm(Task.defaultAccessControlSections));
		...
		public Task ImportTask(string path,  string xmlFile) => RegisterTask(path, File.ReadAllText(xmlFile));
		...
		public void SetAccessControl( TaskSecurity taskSecurity) { taskSecurity.Persist(this); }
		...
		public void SetSecurityDescriptor( GenericSecurityDescriptor sd, SecurityInfos includeSections = Task.defaultSecurityInfosSections) { SetSecurityDescriptorSddlForm(sd.GetSddlForm((AccessControlSections)includeSections)); }
