...
namespace AutorunLibrary.Helpers.TaskScheduler
{
	...
	public abstract partial class Trigger : IDisposable, ICloneable, IEquatable<Trigger>
	{
		...
		internal V2Interop.ITrigger v2Trigger;
		...
		public bool Enabled
		{
			get
			{
				...
				return !v1TriggerData.Flags.HasFlag(V1Interop.TaskTriggerFlags.Disabled);
			}
			set
			{
				if (v2Trigger != null)
		...
		public DateTime EndBoundary
		{
			...
			{
				if (v2Trigger != null)
					return string.IsNullOrEmpty(v2Trigger.EndBoundary) ? DateTime.MaxValue : DateTime.Parse(v2Trigger.EndBoundary, DateTimeUtil.DefaultDateCulture);
				return GetUnboundValueOrDefault(nameof(EndBoundary), v1TriggerData.EndDate.GetValueOrDefault(DateTime.MaxValue));
			}
			set
			{
				if (v2Trigger != null)
					v2Trigger.EndBoundary = value == DateTime.MaxValue ? null : value.ToString(DateTimeUtil.V2BoundaryDateFormat, DateTimeUtil.DefaultDateCulture);
				else
				{
		...
		public TimeSpan ExecutionTimeLimit
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(ExecutionTimeLimit), TimeSpan.Zero);
			}
			set
			{
				if (v2Trigger != null)
		...
		public string Id
		{
			get
			{
				if (v2Trigger != null)
					return v2Trigger.Id;
				return GetUnboundValueOrDefault<string>(nameof(Id));
			}
			set
			{
				if (v2Trigger != null)
		...
		{
			get { return repititionPattern ?? (repititionPattern = new RepetitionPattern(this)); }
		...
		public DateTime StartBoundary
		{
			get
			{
				if (v2Trigger != null)
				{
					...
					{
						DateTime ret = DateTime.Parse(v2Trigger.StartBoundary, DateTimeUtil.DefaultDateCulture);
						if (v2Trigger.StartBoundary.EndsWith("Z"))
							ret = ret.ToUniversalTime();
						return ret;
					}
				}
				return GetUnboundValueOrDefault(nameof(StartBoundary), v1TriggerData.BeginDate);
			}
			set
			{
				if (v2Trigger != null)
					v2Trigger.StartBoundary = value == DateTime.MinValue ? null : value.ToString(DateTimeUtil.V2BoundaryDateFormat, DateTimeUtil.DefaultDateCulture);
				else
				{
		...
		protected virtual void CheckBindValue(string key, ref object o)
		{
			...
			if (o is DateTime)
			{
				if ((key == "EndBoundary" && ((DateTime)o) == DateTime.MaxValue) || (key == "StartBoundary" && ((DateTime)o) == DateTime.MinValue))
					...
					o = ((DateTime)o).ToString(DateTimeUtil.V2BoundaryDateFormat, DateTimeUtil.DefaultDateCulture);
			}
		}
		...
		{
			object val;
			return unboundValues.TryGetValue(prop, out val) ? (T)val : def;
		}
	...
	public sealed class BootTrigger : Trigger, ITriggerDelay
	{
		...
		public TimeSpan Delay
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(Delay), TimeSpan.Zero);
			}
			set
			{
				if (v2Trigger != null)
	...
	public sealed class CustomTrigger : Trigger, ITriggerDelay
	{
		...
		/// </summary>
		/// <returns>String describing the trigger.</returns>
		protected override string V2GetTriggerString() => AutorunLibrary.Properties.Resources.TriggerCustom1;
	...
	public sealed class DailyTrigger : Trigger, ICalendarTrigger, ITriggerDelay, IXmlSerializable
	{
		...
		public TimeSpan RandomDelay
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(RandomDelay), TimeSpan.Zero);
			}
			set
			{
				if (v2Trigger != null)
	...
	public sealed class EventTrigger : Trigger, ITriggerDelay
	{
		...
		public string Subscription
		{
			get
			{
				...
				return GetUnboundValueOrDefault<string>(nameof(Subscription));
			}
			set
			{
				if (v2Trigger != null)
		...
		public NamedValueCollection ValueQueries => nvc ?? (nvc = v2Trigger == null ? new NamedValueCollection() : new NamedValueCollection(((V2Interop.IEventTrigger)v2Trigger).ValueQueries));
		...
		public bool GetBasic(out string log, out string source, out int? eventId)
		{
			...
			{
				using (System.IO.MemoryStream str = new System.IO.MemoryStream(Encoding.UTF8.GetBytes(Subscription)))
				{
	...
	public sealed class LogonTrigger : Trigger, ITriggerDelay, ITriggerUserId
	{
		...
		public string UserId
		{
			get
			{
				...
				return GetUnboundValueOrDefault<string>(nameof(UserId));
			}
			set
			{
				if (v2Trigger != null)
	...
	public sealed class MonthlyDOWTrigger : Trigger, ICalendarTrigger, ITriggerDelay, IXmlSerializable
	{
		...
		public bool RunOnLastWeekOfMonth
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(RunOnLastWeekOfMonth), false);
			}
			set
			{
				if (v2Trigger != null)
		...
		public WhichWeek WeeksOfMonth
		{
			get
			{
				if (v2Trigger != null)
				{
					...
					return GetUnboundValueOrDefault(nameof(WeeksOfMonth), WhichWeek.FirstWeek);
			}
			set
			{
				if (v2Trigger != null)
	...
	public sealed class MonthlyTrigger : Trigger, ICalendarTrigger, ITriggerDelay, IXmlSerializable
	{
		...
		public bool RunOnLastDayOfMonth
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(RunOnLastDayOfMonth), false);
			}
			set
			{
				if (v2Trigger != null)
	...
	public sealed class RepetitionPattern : IDisposable, IXmlSerializable, IEquatable<RepetitionPattern>
	{
		...
		private readonly V2Interop.IRepetitionPattern v2Pattern;
	...
	public sealed class SessionStateChangeTrigger : Trigger, ITriggerDelay, ITriggerUserId
	{
		...
		public TaskSessionStateChangeType StateChange
		{
			get
			{
				...
				return GetUnboundValueOrDefault(nameof(StateChange), TaskSessionStateChangeType.ConsoleConnect);
			}
			set
			{
				if (v2Trigger != null)
