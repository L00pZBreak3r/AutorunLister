...
namespace AutorunLibrary.Helpers
{
  public static class DigitalSignatureVerifier
  {
    ...
    public static string WinVerifyTrustResultToString(WinVerifyTrustResult tr)
    {
      switch (tr)
      {
        case WinVerifyTrustResult.Success:
          return "Verification successful";
        case WinVerifyTrustResult.FileError:
          return "File error";
        case WinVerifyTrustResult.BadMsg:
          return "Bad message";
        case WinVerifyTrustResult.SecuritySettings:
          return "Security settings error";
        case WinVerifyTrustResult.ASN1BadTag:
          return "Bad ASN1 tag";
        case WinVerifyTrustResult.CounterSigner:
          return "CounterSigner";
        case WinVerifyTrustResult.BadDigest:
          return "Bad Digest";
        case WinVerifyTrustResult.FunctionCallFailed:
          return "Function call failed";
        case WinVerifyTrustResult.NoSignature:
          return "No signature";
        case WinVerifyTrustResult.CertExpired:
          return "Certificate expired";
        case WinVerifyTrustResult.CertUntrustedRoot:
          return "Certificate Untrusted Root";
        case WinVerifyTrustResult.CertChaining:
          return "Certificate Chaining error";
        case WinVerifyTrustResult.CertRevoked:
          return "Certificate revoked";
        case WinVerifyTrustResult.CertWrongUsage:
          return "Certificate WrongUsage";
        case WinVerifyTrustResult.ExplicitDistrust:
